...
@Schema(description = "Payload for creating a policy")
public record CreatePolicyRequest(
		@Schema(description = "Risk type", example = "WORK_INJURY")
		...
		@Schema(description = "Maximum total payout for this policy and risk", example = "1000000.00")
		BigDecimal maxPerPolicyTotal,
		...
		Date endDate,
		@Schema(description = "Daily payout percent (for example 0.5 means 0.5% per day)", example = "0.5")
